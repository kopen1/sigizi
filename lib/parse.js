...
function extractHiddenInputs(fragment) {
  const result = {};
...
function extractFormFields(fragment) {
  const fields = {};
...
module.exports = {
  ...
  findForm: findForm,
  extractHiddenInputs: extractHiddenInputs,
  extractCaptchaPath: extractCaptchaPath,
  extractFirst: extractFirst,
  extractMeasurements: extractMeasurements,
